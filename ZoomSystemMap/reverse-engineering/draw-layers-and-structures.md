...
Layer 5's GPTP wrapper must remain active in private passes. It calls native
world rendering and then draws queued Cosmonarchy map graphics such as rally
lines.
...
- Never replace the layer-5 function pointer with the raw StarCraft function.
