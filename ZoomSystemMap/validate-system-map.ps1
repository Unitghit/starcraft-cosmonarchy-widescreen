...
$requiredSourcePatterns = @(
    ...
    @{ Path = $limitsSource; Pattern = 'EnsureGptpSelectionBounds' },
    @{ Path = $limitsSource; Pattern = 'ctrl_width_rva = 0x000B5437' },
    @{ Path = $limitsSource; Pattern = 'ctrl_shift_height_rva = 0x000B5542' },
    @{ Path = $inputSource; Pattern = 'expanded_battlefield_drag_active' },
    @{ Path = $inputSource; Pattern = '!expanded_battlefield_drag_active' },
    ...
    @{ Path = $limitsSource; Pattern = 'EnsureGptpControlGroupCameraCenter' },
    @{ Path = $limitsSource; Pattern = 'single_rva = 0x00046DC7' },
    @{ Path = $limitsSource; Pattern = 'group_rva = 0x00047135' },
