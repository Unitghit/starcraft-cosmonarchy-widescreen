...
BW_FUNC(int(void *, int, int), STransGetPixel, 0x00410166, Stack, Stack, Stack);
...
BW_FUNC(int(int, int, int, Unit*, int, Unit*, int), WeaponDamage, 0x00479930, Stack, Stack, Stack, Stack, Stack, Edi, Eax);
