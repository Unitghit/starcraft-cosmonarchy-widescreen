...
namespace bw
{
    ...
    const offset<int> trans_mouse_y_min = 0x00596B6C;
    const offset<int> trans_mouse_y_max = 0x00596B74;
    const offset<uint32_t> context_help_visible = 0x00655C48;
    ...
    const offset<uint32_t> replay_viewers = 0x00640970;
    ...
    const offset<Unit *> active_portrait_unit = 0x00597248;
	...
	const offset<uint32_t> used_unit_count = 0x006283F0;
    ...
    const offset<uint32_t> screen_x = 0x0062848C;
    ...
    const offset<void *> left_click_proc = 0x006556EC;
    const offset<void *> right_click_proc = 0x006556F0;
	...
	//IQUARE
	const offset<uint32_t*> bw_deaths = 0x0058A364;
